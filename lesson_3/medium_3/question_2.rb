...
# The method also has a separate scope and so although it can use the values passed to it, it doesn't
# alter the values of the variables outside of the method
