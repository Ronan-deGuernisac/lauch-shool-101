...
# As this code runs, the variables referenced within the do/ end block will be changed within that block
# but when referenced again outside of the block the original values will be returned - i.e. although
# the names of the variable inside and outside of the block are the same they exist in different scopes
# and so are acutally different variables
